...
const services: Service[] = [
  {
    ...
    description: 'In-depth human-driven testing for intuitive user experience and functionality',
    icon: HiBeaker,
  },
  {
    title: 'Automation Testing',
    description: 'Efficient automated test solutions for continuous integration',
    icon: HiCode,
  },
  {
  ...
  return (
    <section className="py-24 section-gradient">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold heading-gradient mb-6">Our Services</h2>
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
            We provide comprehensive software testing solutions to ensure your applications
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-semibold mb-4 text-accent-primary">{service.title}</h3>
