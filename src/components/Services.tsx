...
const services: Service[] = [
  {
    ...
    description:
      "Human-driven testing that ensures your application works exactly as users expect",
    icon: HiBeaker,
    features: [
  ...
  },
  {
    ...
    description:
      "Efficient automated test solutions for continuous integration and faster releases",
    icon: HiCode,
    features: [
      "Selenium WebDriver",
      "API Test Automation",
  ...
  },
  {
    ...
    description:
      "Optimize your application's speed, scalability and reliability under various load conditions",
  ...
  },
  {
    ...
    description:
      "Comprehensive security assessment to protect your application from vulnerabilities",
    icon: HiShieldCheck,
    features: [
      "Penetration Testing",
  ...
  },
  {
    ...
    description:
      "Complete mobile app testing across iOS and Android platforms for optimal user experience",
    icon: HiDeviceMobile,
    features: [
  ...
  },
  {
    title: "API Testing",
    description:
      "Thorough API testing to ensure reliable data exchange and system integration",
    icon: HiGlobe,
    features: [
      "REST API Testing",
      "SOAP Testing",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-4xl mx-auto">
            From manual testing to advanced security assessments, we provide
            end-to-end quality assurance solutions that ensure your software
            exceeds industry standards and user expectations.
          </p>
        </motion.div>
